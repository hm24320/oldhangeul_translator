...
def main() -> None:
    # Try to get project root from __file__ first, fallback to current directory
    try:
    ...
    default_src = os.path.join(default_base, "번역본")
    default_dst = os.path.join(default_base, "번역본_완성형")
